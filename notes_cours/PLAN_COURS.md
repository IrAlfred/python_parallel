...
| Partie | Chapitres | Durée | % |
|--------|-----------|-------|---|
| Partie 1 : Introduction | 1-3 | 8h | 13% |
| Partie 2 : Threading | 4-6 | 12h | 20% |
| Partie 3 : Multiprocessing | 7-9 | 14h | 23% |
| Partie 4 : Asynchrone | 10-12 | 10h | 17% |
| Partie 5 : Patterns | 13-14 | 8h | 13% |
| Partie 6 : Distribué | 15-17 | 8h | 13% |
| **TOTAL** | **17 chapitres** | **60h** | **100%** |

---

## Structure d'un chapitre type

Chaque fichier `.md` suivra cette structure :
...
### 1.1 [Sous-titre conceptuel]
[Explication détaillée du concept]

### 1.2 [Sous-titre conceptuel]
[Explication détaillée du concept]
...
[Ce qui doit être affiché/obtenu]

## 3. Exemple avancé

### 3.1 Description
[Description du cas d'usage plus complexe]
...
### 3.3 Explication
[Explication approfondie de l'implémentation]
...
### Exercice 1 : [Titre]
**Difficulté** : Facile
**Objectif** : [Objectif de l'exercice]
**Énoncé** : [Description détaillée]
**Indices** : [Si nécessaire]
**Solution** : [Code solution commenté]
...
1. **Semaines 1-2** (16h) : Introduction et Threading
2. **Semaines 3-4** (16h) : Multiprocessing
3. **Semaines 5-6** (16h) : Asynchrone et Patterns
4. **Semaines 7-8** (12h) : Programmation Distribuée et Projet final
